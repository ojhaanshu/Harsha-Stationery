...
public class updateProduct extends JFrame implements ActionListener{
    ...
    ImageIcon sidepic = (new ImageIcon("C:\\Users\\Jay Tiwari\\Downloads\\hs images\\updateproduct.png" ));
    ...
    logol.setText("Update Product Details");
    logol.setFont(lf);
    logol.setLayout(null);
    logol.setBounds(16, 49, 500, 40);
    
    jp.add(logol);
    
    JSeparator line2 =new  JSeparator();
    //line.setPreferredSize(new Dimension(390,8));
    line2.setBounds(20,90,300,20);
   ...
   cp.add(gsttf);
    ...
    addbtnpanel.setBounds(450,435,100,30);
    ...
    resetbtnpanel.setBounds(580,435,100,30);
    //addbtnpanel.setBackground( new Color(10,0,0));
        ...
        if(e.getSource()==search ){
           ...
           try{
               ...
               if(rs.next())
               {
                 ...
                 quantitytf.setText(rs.getString(4)); 
        ...
        if(e.getSource()== updatebtn){
           String id = pid .getText();       
            ...
            try{
                Connection con = ConnectionProvider.getCon();
                Statement st=con.createStatement();
                st.executeUpdate("update product_details  set P_Name='"+name+"',P_Quantity='"+qnty+"',P_Price='"+price+"',P_GST_Rate='"+gst+"',P_HSN_Code='"+hsn+"',Supplier_ID='"+supp+"'where P_Id='"+id+"' ");
                JOptionPane.showMessageDialog(null,"Successfully Updated");
                setVisible(false);
                new updateProduct().setVisible(true);
            }
            catch( SQLException s){
                JOptionPane.showMessageDialog(null,s);//"Some Error in execution,Refill \"Correct\" inputs");
                setVisible(false);
                new updateProduct().setVisible(true);
       }
    }
