...
public class updateEmployee extends JFrame implements ActionListener{
   ...
   updateEmployee(){
    ...
    ImageIcon sidepic = (new ImageIcon("C:\\Users\\Jay Tiwari\\Downloads\\hs images\\updateemployee.png"));
    ...
    logol.setText("Update Employee Details");
    logol.setFont(lf);
    ...
    public void actionPerformed(ActionEvent e) {
       ...
       if(e.getSource()==updatebtn){
            ...
            try{
                Connection con = ConnectionProvider.getCon();
                Statement st=con.createStatement();
                st.executeUpdate("update employee  set E_First_Name='"+name+"',E_Last_Name='"+surname+"',E_Contact_No='"+number+"',E_Gender='"+gen+"',E_Address='"+address+"' where Emp_Id = '"+id+"'");
